    ...
    <div class="container    pt-5  text-right" dir="rtl">
        <div class="wmaster">
            ...
            <template v-if="mode=='additem'">
                <form class="form row" @submit.prevent="saveform">
                    ...
                    <div  class="form-group col-sm-6 col-xs-12">
                        ...
                        <!--
                                                <input type="text" dir="ltr" v-model="user.natioanlcode" class="form-control" :placeholder="$t('natioanlcode')" id="natioanlcode">
                        -->
                    </div>
                    <div  class="form-group col-sm-6 col-xs-12">
            ...
            <template v-if="mode=='list'">
                <input v-model="search" class="form-control col-sm-6 col-xs-12" :placeholder="$t('')">
...
<script>
    ...
    import Nationalcode from "../../../Custom/Nationalcode";
    import Province from '../../../../lang/Province';
